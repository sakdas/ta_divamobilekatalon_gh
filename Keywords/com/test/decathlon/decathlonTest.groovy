...
class decathlonTest {
	...
	def Login() {
		...
		Mobile.setText(findTestObject('zWillBeDeleted/LoginObjects/EditText_Username'), 'GSAY28', 0)

		Mobile.tap(findTestObject('zWillBeDeleted/LoginObjects/Password'), 0)

		Mobile.setText(findTestObject('zWillBeDeleted/LoginObjects/EditText_Password'), 'decathlon', 0)
	}
}